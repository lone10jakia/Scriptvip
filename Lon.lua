print("MEMAYBEO HUB PRO - FIXED 100% - MENU SẼ BUNG RA NGAY")
...
MainFrame.Size = UDim2.new(0,610,0,440)
...
UserInputService.InputBegan:Connect(function(k)
    if k.KeyCode == Enum.KeyCode.LeftControl then
        if menuOpen then Close() else Open() end
    end
end)
...
-- Search + Scroll + AddToggle function
...
-- ==================== HEALTH MODE PRO (GIỮ VŨ KHÍ + 0.3s) ====================
...
task.wait(1)
Open() -- ← QUAN TRỌNG: ĐÂY LÀ DÒNG LÀM MENU BUNG RA NGAY LẬP TỨC
