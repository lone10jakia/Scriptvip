print("MEMAYBEO HUB PVP MODE - NO KEY - 2025")
...
SubTitle.Text = "PVP MODE - FREE FOREVER"
SubTitle.TextColor3 = Color3.fromRGB(220,220,220)
SubTitle.Font = Enum.Font.Gotham
SubTitle.TextSize = 15
-- Search box + Scrolling frame
...
-- ==================== HEALTH MODE PRO (TỰ BĂNG BÓ + GIỮ VŨ KHÍ) ====================
...
-- ==================== CÁC CHỨC NĂNG CÒN LẠI + MỞ MENU TỰ ĐỘNG ====================
...
-- ==================== MỞ MENU TỰ ĐỘNG + THÔNG BÁO ====================
task.wait(0.8)
-- Đã mở sẵn từ đầu, không cần Open() nữa vì Position đã là (0,0)
...
██║ ╚═╝ ██║███████╗██║ ╚═╝ ██║██║  ██║   ██║   ██████╔╝███████╗╚██████╔╝
╚═╝     ╚═╝╚══════╝╚═╝     ╚═╝╚═╝  ╚═╝   ╚═╝   ╚═════╝ ╚══════╝ ╚═════╝ 
                     PVP MODE - FREE 100% - MEMAYBEO WAS HERE
]]

Fluent:Notify({
    Title = "MEMAYBEO HUB",
    Content = "LOAD XONG - KHÔNG KEY - MENU ĐÃ MỞ!\nBẬT COMBO BẤT TỬ VÀ ĐẬP CHẾT CẢ SERVER ĐI ĐẠI CA!!!",
    Duration = 10
})
